...
import dCircle from "../../assets/designCircle.svg";
  ...
  const serviceDivData = [
    {
      ...
      imgtext2:
        "Rank higher on Google searches and increase website traffic from search engines.",
      servicesText:
    ...
    },
    {
      ...
      serviceLists: ["Responsive Design", "Wireframing", "UX Writing"],
      imgtext1: "Crafting Unique Digital Identities",
      imgtext2:
        "I tailor your Brand identity to your audience, With a focus on distinctive visuals and writing",
      servicesText:
