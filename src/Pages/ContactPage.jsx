      ...
      <div className="contact-grid">
        ...
        <div className="gridDiv">
          <form ref={formRef} onSubmit={sendEmail}>
              ...
              <div className="fC flexbtn">
                {["Web Development", "Web Design"].map((service) => (
                  <button
                    ...
                    className={`service-btn ${formData.clientService.includes(service) ? "selected clicked-btn" : ""}`}
            ...
            {[
              { label: "Name", name: "user_name" , type: "text", placeholder: "ie Clients Name", required: true },
              { label: "Email", name: "user_email" , type: "email", placeholder: "ie Client email@google.com", required: true },
              { label: "Phone Number", name: "user_phone", type: "tel", placeholder: "ie +234 000 000 0000", required: true },
              { label: "Appointment Date", name: "appointmentDate", type: "date", placeholder: "", required: false },
              { label: "Message", name: "message", type: "textarea", placeholder: "@hi kenny, im name, ..", required: false },
            ].map(({ label, name, type, placeholder, required }) => (
              <div className="form-group" key={name}>
                <label htmlFor={name}>
                  {label} {required && <span className="orangeColor">*</span>}
                </label>
                {type === "textarea" ? (
                  <textarea
                    id={name}
